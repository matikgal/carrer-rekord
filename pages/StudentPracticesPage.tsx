...
import { TimelineEvent, Testimonial, Faq, Memory, InternshipProject } from '../types/database';
...
const StudentPracticesPage = () => {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      ...
      if (projectsRes.data) setProjects(projectsRes.data as InternshipProject[]);
